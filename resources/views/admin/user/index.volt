                                ...
                                <div class="layui-form-item" style="margin-bottom: -4px;">
                                    <div class="layui-inline">
                                        <div class="layui-input-inline">
                                            <input class="layui-input" v-model="search.name" name="name" placeholder="{{ lang._('user.name') }}">
                                        </div>
                                    </div>
                                    <div class="layui-inline">
                                                ...
                                                <table class="layui-table">
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>{{ lang.t('user.name') }}</th>
                                                            <th>{{ lang.t('user.username') }}</th>
                                                            <th>{{ lang.t('user.role') }}</th>
...
{% endblock %}
{% block js %}
<script type="text/javascript" src="{{ static_url('/admin/js/static/user.js')}}"></script>
{% endblock %}
